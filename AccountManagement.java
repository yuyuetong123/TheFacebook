...
public class AccountManagement {
    ...
    public void createPost(String content){
        ...
        Post newPost=new Post(this.user,content);
        this.user.getPage().add(newPost);
    ...
    public Period getRemainingBannedTime() {
        if (this.user.isBanned() && this.user.getBanEndDate() != null) {
            LocalDate currentDate = LocalDate.now();
            return Period.between(currentDate, this.user.getBanEndDate());
        }else if(this.user.isBanned() && this.user.getBanEndDate() == null){
    ...
    public void createGroup(String groupName) {
        ...
        this.user.getGroupsList().add(newGroup);
    }
